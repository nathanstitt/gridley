...
For an usable example of the screenshots above, try [the sandbox example](https://codesandbox.io/s/58qvy9?module=/example.tsx) as well as the source in [demo/demo.tsx](demo/demo.tsx)
