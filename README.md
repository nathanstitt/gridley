...
For an usable example of the screenshots above, try [the sandbox example](https://codesandbox.io/s/ocxfdh?module=/example.tsx) as well as the source in [demo/demo.tsx](demo/demo.tsx)
