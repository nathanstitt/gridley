...
For an usable example of the screenshots above, try [the sandbox example](https://codesandbox.io/s/5nx2hz?module=/example.tsx) as well as the source in [demo/demo.tsx](demo/demo.tsx)
